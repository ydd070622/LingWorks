// China administrative divisions data
// Province → cities → districts mapping
...
const regionData: RegionData = {
  ...
  '河北省': {
    ...
    '秦皇岛市': ['海港区', '山海关区', '北戴河区', '青龙满族自治县', '昌黎县', '卢龙县'],
    '邯郸市': ['邯山区', '丛台区', '复兴区', '峰峰矿区', '临漳县', '成安县', '大名县', '涉县', '磁县', '邱县', '鸡泽县', '广平县', '馆陶县', '魏县', '曲周县', '武安市'],
    '邢台市': ['襄都区', '信都区', '任泽区', '南和区', '临城县', '内丘县', '柏乡县', '隆尧县', '任县', '南和县', '宁晋县', '巨鹿县', '新河县', '广宗县', '平乡县', '威县', '清河县', '临西县', '南宫市', '沙河市'],
  ...
  '吉林省': {
    ...
    '松原市': ['宁江区', '前郭尔罗斯蒙古族自治县', '长岭县', '扶余市', '前郭县'],
  ...
  '云南省': {
    ...
    '普洱市': ['思茅区', '宁洱哈尼族彝族自治县', '墨江哈尼族自治县', '景东彝族自治县', '景谷傣族彝族自治县', '镇沅彝族哈尼族拉祜族自治县', '江城哈尼族彝族自治县', '孟连傣族拉祜族佤族自治县', '澜沧拉祜族自治县'],
  ...
  '陕西省': {
    ...
    '安康市': ['汉滨区', '汉阴县', '石泉县', '宁陕县', '紫阳县', '岚皋县', '平利县', '镇坪县', '旬阳市'],
  ...
  '台湾省': {
    ...
    '高雄市': ['新兴区', '前金区', '苓雅区', '盐埕区', '鼓山区', '旗津区', '前镇区', '三民区', '楠梓区', '小港区'],
...
export function getSortedProvinces(): string[] {
  // Sort provinces by common order (municipalities first, then by pinyin)
  const municipalities = ['北京市', '天津市', '上海市', '重庆市']
  const others = Object.keys(regionData).filter(p => !municipalities.includes(p))
  return [...municipalities, ...others]
}
