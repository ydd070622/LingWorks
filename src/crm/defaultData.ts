...
export function createDefaultData(): CRMData {
  ...
  const customers: Customer[] = [
    { id: 'c1', name: '张女士', phone: '138****6789', wechat: 'zhang_xx', source: 'xiaohongshu', sourceNoteId: 'n1', stage: 'followup', houseType: '三室两厅', city: '20万', style: '意式极简', followUpDate: fmt(a(now, 1)), followUpNote: '客户说6.19才有空', dealAmount: null, notes: '对意式极简很感兴趣，发了户型图。需等先生一起看方案。', createdAt: '2026-06-10', updatedAt: '2026-06-15', followUpHistory: [{ id: 'fu_c1_1', date: '2026-06-10', content: '小红书私信加微信，客户对意式极简很感兴趣', nextDate: '2026-06-13' }, { id: 'fu_c1_2', date: '2026-06-15', content: '客户说6.19才有空，发了户型图，需等先生一起看方案', nextDate: fmt(a(now, 1)) }] },
